<template>
  <div id="app-slider" class="wrapper" :class="{ 'is-previous': isPreviousSlide, 'first-load': isFirstLoad }">
    <div
      class="slide-wrapper"
    ...
    >
      <div class="slide-inner">
        ...
        <h2 class="slide-side-text">
          <span>{{ slide.sublineFirstLine }} </span><span>{{ slide.sublineSecondLine }}</span>
        </h2>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      slides: [
        {
          headlineFirstLine: 'Бургеры',
          headlineSecondLine: 'Пицца',
          sublineFirstLine: 'С мясом',
          sublineSecondLine: 'из смокера',
          bgImg:
            'https://images.unsplash.com/photo-1559671743-c67a25c1c665?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1470&q=80',
          rectImg: 'https://i.postimg.cc/vTW0XkvM/slide-rect0.jpg',
        },
        {
          headlineFirstLine: 'Мясо',
          headlineSecondLine: 'Рыба',
          sublineFirstLine: 'Копченые в смокере',
        ...
        {
          headlineFirstLine: 'Эксклюзивно',
          headlineSecondLine: '',
          sublineFirstLine: 'Джем из бекона',
          sublineSecondLine: '',
          bgImg: 'https://media.gettyimages.com/photos/gourmet-bacon-jam-picture-id900464430?s=2048x2048',
...
.slide-content-text > p:nth-child(2) {
  padding-left: 10rem;
}
